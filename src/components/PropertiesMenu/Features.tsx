    ...
    <>
          ...
          <label>
            ...
            {currentObjectId < objectList.length ? (
              <input
                ...
                value={objectList[currentObjectId].height}
              />
            ) : (
              <input
                type={"text"}
          ...
          <label>
            ...
            {currentObjectId < objectList.length ? (
              <input
                ...
                value={objectList[currentObjectId].width}
              />
            ) : (
          ...
          <label>
            ...
            {currentObjectId < objectList.length ? (
              <input
                type={"text"}
                id="angle"
                onChange={handleInputChangeAngle}
                placeholder={`${objectList[currentObjectId].angle}\u00B0`}
                value={`${objectList[currentObjectId].angle}\u00B0`}
              />
            ) : (
              <input
                type={"text"}
          ...
          <label>
            ...
            {currentObjectId < objectList.length ? (
              <input
                ...
                value={objectList[currentObjectId].left}
              />
            ) : (
          ...
          <label>
            ...
            {currentObjectId < objectList.length ? (
              <input
                ...
                value={objectList[currentObjectId].top}
              />
            ) : (
      ...
      <div className={styles.position}>
        <div
          ...
          onClick={() => handleInputUpObject()}
        >
          <ButtonIcon icon={<LayersUpIcon />} />
        </div>
        <div
          className={styles.position__button}
          onClick={() => handleInputDownObject()}
        >
          <ButtonIcon icon={<LayersDownIcon />} />
        </div>
        <div
          className={styles.position__button}
          onClick={() => handleInputhorizontalMirroring()}
        >
          <ButtonIcon icon={<ReflectionHIcon />} />
        </div>
        <div
          className={styles.position__button}
          onClick={() => handleInputverticalMirroring()}
        >
      ...
      <div className={styles.settings__field}>
        <div className={styles.settings__sub_title}>объект изначально</div>
        {
          objectList[currentObjectId].visible ? (
            <Tabs
              options={["ВИДЕН", "СКРЫТ"]}
              onClick={() => handleInputChangeVisibility()}
            />
          ) : (
