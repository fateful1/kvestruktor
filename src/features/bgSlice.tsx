...
export const setActiveBg =
  (bg: { image: string; width: number; height: number }) =>
  (dispatch: (arg0: { payload: any; type: "bg/setBg" }) => void) => {
    console.log(bg);
    dispatch(setBg(bg));
  };

export const changeBgX =
  (x: any) =>
  (
    dispatch: (arg0: { payload: any; type: "bg/changeBackgroundX" }) => void
  ) => {
